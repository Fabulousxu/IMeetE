...
public class UserControllerTest {
  ...
  public void getUserInfo_Success() throws Exception {
    ...
    mockMvc
        .perform(get("/user").param("id", "user1"))
  ...
  public void getSelfInfo_Success() throws Exception {
    ...
    mockMvc
        .perform(get("/user/self").cookie(new MockCookie("userId", "user1")))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(jsonPath("$.userId").value("user1"))
        .andExpect(jsonPath("$.username").value("John Doe"));
  ...
  public void getUserInfo_NotFound() throws Exception {
    ...
    mockMvc
        .perform(get("/user").param("id", "user999"))
  ...
  public void getSelfInfo_Unauthorized() throws Exception {
    ...
    mockMvc
        .perform(get("/user/self").cookie(new MockCookie("userId", "user0")))
        .andExpect(status().isOk()) // 检查状态码为200
  ...
  public void getUserPosts_Success() throws Exception {
    ...
    mockMvc
        .perform(get("/user/post").param("id", "user1").cookie(new MockCookie("userId", "user1")))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
  ...
  public void getSelfPosts_Success() throws Exception {
    ...
    mockMvc
        .perform(get("/user/self/post").cookie(new MockCookie("userId", "user1")))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
  ...
  public void getUserCollect_Success() throws Exception {
    ...
    mockMvc
        .perform(
            get("/user/collect").param("id", "user1").cookie(new MockCookie("userId", "user1")))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
  ...
  public void getSelfCollect_Success() throws Exception {
    ...
    mockMvc
        .perform(get("/user/self/collect").cookie(new MockCookie("userId", "user1")))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
