...
public class UserController {
  ...
  public JSONArray getSelfPost(@CookieValue("userId") String userId) {
    ...
    for (Post post : userService.getPost(userId)) res.add(postService.toJson(post, userId));
    return res;
  }
  ...
  public JSONArray getSelfCollect(@CookieValue("userId") String userId) {
    JSONArray res = new JSONArray();
    for (Post post : userService.getCollect(userId)) res.add(postService.toJson(post, userId));
    return res;
  }
}
